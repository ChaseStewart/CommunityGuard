...
CREATE TABLE bad_ipv4_input( id INT AUTO_INCREMENT, ip_addr INT UNSIGNED NOT NULL, hash_val BINARY(32) NOT NULL, primary key (id) );
...
CREATE TABLE mac_addr_registry (id INT AUTO_INCREMENT, hash_val BINARY(32) NOT NULL, primary key (id) );
...
CREATE TABLE bad_ipv4_master_list ( id INT UNSIGNED NOT NULL AUTO_INCREMENT, hash BINARY(32) NOT NULL, primary key (id) );
