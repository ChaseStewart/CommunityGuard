...
echo
wget http://rules.emergingthreatspro.com/open/snort-2.9.0/emerging.rules.zip &>/dev/null
unzip /home/debian/emerging.rules.zip
...
cp /home/debian/deploy/avant_guard_ddos.rules /etc/snort/rules/avant_guard_ddos
